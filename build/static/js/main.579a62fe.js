/*! For license information please see main.579a62fe.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      730: (e, t, n) => {
  ...
  (n.m = e),
    ...
    (n.u = (e) => "static/js/" + e + ".48fb84c1.chunk.js"),
    (n.miniCssF = (e) => {}),
    ...
    (() => {
      ...
      var t = (t, r) => {
        ...
        r = (self.webpackChunkgittotext = self.webpackChunkgittotext || []);
    ...
    (() => {
      ...
      const h = c("string"),
        ...
        S = s("FileList"),
        E = s("URLSearchParams"),
        [x, C, _, T] = ["ReadableStream", "Request", "Response", "Headers"].map(
          s,
        );
      function N(e, t) {
        let n,
      ...
      const F = s("HTMLFormElement"),
        ...
        M = "0123456789",
        I = { DIGIT: M, ALPHA: U, ALPHA_DIGIT: U + U.toUpperCase() + M };
      ...
      const X = V.toFlatObject(V, {}, null, function (e) {
              ...
              return (
                ...
                i.forEach(function (e, r) {
                  !V.isUndefined(e) &&
                    null !== e &&
                    t.append(
                      !0 === o ? J([n], r, l) : null === o ? n : n + "[]",
                      u(e),
                    );
                }),
                !1
              );
          return !!Q(e) || (t.append(J(a, n, l), u(e)), !1);
        }
        const c = [],
          f = Object.assign(X, {
            defaultVisitor: s,
        ...
        return (
          (function e(n, r) {
            if (!V.isUndefined(n)) {
              ...
              c.push(n),
                V.forEach(n, function (n, l) {
                  !0 ===
                    (!(V.isUndefined(n) || null === n) &&
                      a.call(t, n, V.isString(l) ? l.trim() : l, r, f)) &&
                    e(n, r ? r.concat(l) : [l]);
                }),
                c.pop();
            }
      ...
      const ae = class {
        ...
        ue =
          ...
          ie && ["ReactNative", "NativeScript", "NS"].indexOf(se) < 0);
      var se;
      const ce =
          "undefined" !== typeof WorkerGlobalScope &&
          self instanceof WorkerGlobalScope &&
          "function" === typeof self.importScripts,
        fe = (ie && window.location.href) || "http://localhost",
        de = { ...e, ...oe };
      const pe = function (e) {
        function t(e, n, r, a) {
          let l = e[a++];
          ...
          const o = Number.isFinite(+l),
            i = a >= e.length;
          if (((l = !l && V.isArray(r) ? r.length : l), i))
            return V.hasOwnProp(r, l) ? (r[l] = [r[l], n]) : (r[l] = n), !o;
      ...
      const he = {
        ...
        transformRequest: [
          function (e, t) {
            ...
            if (V.isFormData(e)) return r ? JSON.stringify(pe(e)) : e;
            if (
              V.isArrayBuffer(e) ||
              V.isBuffer(e) ||
              V.isStream(e) ||
      ...
      class ke {
        ...
        set(e, t, n) {
          ...
          if (V.isPlainObject(e) || e instanceof this.constructor) l(e, t);
          else if (
            V.isString(e) &&
            (e = e.trim()) &&
          ...
          else if (V.isHeaders(e)) for (const [o, i] of e.entries()) a(i, o, n);
          else null != e && a(t, e, n);
          return this;
        }
        get(e, t) {
        ...
        clear(e) {
          ...
          for (; n--; ) {
            const a = t[n];
            (e && !we(0, this[a], a, e, !0)) || (delete this[a], (r = !0));
          }
          return r;
        }
        normalize(e) {
          ...
          return (
            V.forEach(this, (r, a) => {
              ...
              if (l) return (t[l] = be(r)), void delete t[a];
              const o = e
                ? (function (e) {
                    return e
                      .trim()
      ...
      const Ae = (e) => {
          ...
          if (
            ...
            (t.url = re(ze(t.baseURL, t.url), e.params, e.paramsSerializer)),
            u &&
              i.set(
                "Authorization",
                "Basic " +
          ...
          if (
            ...
            (a && V.isFunction(a) && (a = a(t)), a || (!1 !== a && Oe(t.url)))
          ) {
            const e = l && o && Le.read(o);
            e && i.set(l, e);
          }
          return t;
        },
        je =
          ...
          function (e) {
            return new Promise(function (t, n) {
              const r = Ae(e);
              let a = r.data;
              const l = Se.from(r.headers).normalize();
              let o,
                { responseType: i } = r;
              function u() {
              ...
              s.open(r.method.toUpperCase(), r.url, !0),
                ...
                (s.onabort = function () {
                  s &&
                    (n(new q("Request aborted", q.ECONNABORTED, r, s)),
                    (s = null));
                }),
                (s.onerror = function () {
                  n(new q("Network Error", q.ERR_NETWORK, r, s)), (s = null);
                }),
                (s.ontimeout = function () {
                  let e = r.timeout
                    ? "timeout of " + r.timeout + "ms exceeded"
                    : "timeout exceeded";
                  const t = r.transitional || le;
                ...
                "function" === typeof r.onDownloadProgress &&
                  s.addEventListener("progress", Re(r.onDownloadProgress, !0)),
                "function" === typeof r.onUploadProgress &&
                  s.upload &&
                  s.upload.addEventListener("progress", Re(r.onUploadProgress)),
                (r.cancelToken || r.signal) &&
                  ((o = (t) => {
                    s &&
                      (n(!t || t.type ? new _e(null, e, s) : t),
                      s.abort(),
                      (s = null));
                  }),
        ...
        Ue = (e, t) => {
          ...
          const a = function (e) {
            if (!n) {
              ...
              r.abort(
                t instanceof q ? t : new _e(t instanceof Error ? t.message : t),
              );
            }
          };
          let l =
            t &&
            setTimeout(() => {
              a(new q("timeout ".concat(t, " of ms exceeded"), q.ETIMEDOUT));
            }, t);
          const o = () => {
            e &&
              (l && clearTimeout(l),
        ...
        Ie = (e, t, n, r, a) => {
          const l = (async function* (e, t, n) {
            for await (const r of e)
              yield* Me(ArrayBuffer.isView(r) ? r : await n(String(r)), t);
          })(e, t, a);
          let o = 0;
        ...
        He = Ve && "function" === typeof ReadableStream,
        We =
          Ve &&
      ...
      const qe =
        ...
        Ke = { stream: Qe && ((e) => e.body) };
      var Je;
      Ve &&
        ((Je = new Response()),
        ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((e) => {
          !Ke[e] &&
            (Ke[e] = V.isFunction(Je[e])
              ? (t) => t[e]()
              : (t, n) => {
                  throw new q(
                    ...
                    : V.isSpecCompliantForm(e)
                      ...
                      : V.isArrayBufferView(e)
                        ...
                        : (V.isURLSearchParams(e) && (e += ""),
                          V.isString(e) ? (await We(e)).byteLength : void 0))(t)
            : n;
        },
        Ye = {
          http: null,
              ...
              try {
                if (
                  ...
                  V.isFormData(r) &&
                    ...
                    c.setContentType(e),
                    n.body && (r = Ie(n.body, 65536, Be(v, Re(u)), null, We));
                }
                V.isString(f) || (f = f ? "cors" : "omit"),
                  (h = new Request(t, {
                    ...d,
                    signal: m,
                ...
                let a = await fetch(h);
                const l = Qe && ("stream" === s || "response" === s);
                if (Qe && (i || l)) {
                  const e = {};
                  ...
                  a = new Response(
                    Ie(a.body, 65536, i && Be(t, Re(i, !0)), l && y, We),
                    e,
                  );
                }
                s = s || "text";
                let o = await Ke[V.findKey(Ke, s) || "text"](a, e);
                return (
                  !l && y(),
                  g && g(),
      ...
      const Ge = (e) => "- ".concat(e),
        Ze = (e) => V.isFunction(e) || null === e || !1 === e,
        et = (e) => {
          e = V.isArray(e) ? e : [e];
          const { length: t } = e;
          let n, r;
          ...
          for (let l = 0; l < t; l++) {
            ...
            if (
              ((n = e[l]),
              (r = n),
              !Ze(n) && ((r = Ye[(t = String(n)).toLowerCase()]), void 0 === r))
            )
      ...
      function nt(e) {
        ...
        return et(e.adapter || me.adapter)(e).then(
          function (t) {
            return (
              tt(e),
      ...
      class ut {
        ...
        getUri(e) {
          return re(
            ze((e = De(this.defaults, e)).baseURL, e.url),
            e.params,
            e.paramsSerializer,
          );
        }
      ...
      class ct {
        constructor(e) {
          ...
          this.promise.then((e) => {
            ...
            e(function (e, r, a) {
              n.reason || ((n.reason = new _e(e, r, a)), t(n.reason));
            });
        }
        throwIfRequested() {
      ...
      const ht = (function e(t) {
        const n = new st(t),
          r = a(st.prototype.request, n);
        return (
          V.extend(r, st.prototype, n, { allOwnKeys: !0 }),
      ...
      (ht.Axios = st),
        ...
        (ht.mergeConfig = De),
        (ht.AxiosHeaders = Se),
        (ht.formToJSON = (e) => pe(V.isHTMLForm(e) ? new FormData(e) : e)),
        (ht.getAdapter = et),
        (ht.HttpStatusCode = pt),
        (ht.default = ht);
      const mt = ht;
      var gt = n(579);
      const yt = function () {
          ...
          return (0, gt.jsxs)("div", {
            className: "container ".concat(p ? "dark-mode" : ""),
            children: [
              (0, gt.jsxs)("div", {
                    ...
                    children: [
                      (0, gt.jsxs)("div", {
                        children: [
                          ...
                          (0, gt.jsx)("label", { children: "All Files" }),
                        ],
                      }),
                      (0, gt.jsxs)("div", {
                        children: [
                      ...
                      children: [
                        ...
                        (0, gt.jsxs)("div", {
                          children: [
                            ...
                            (0, gt.jsx)("button", {
                              onClick: () => {
                                console.log("Adding custom file type:", f),
                                  f && !m.includes(f) && m.push(f),
                                  d("");
                              },
                              className: "addButton",
                              children: "Add",
                ...
                children: [
                  (0, gt.jsx)("button", {
                    onClick: async (t) => {
                      ...
                      "all" === s && (n = m);
                      try {
                        const t = await mt.post("/api/scrape", {
                          repoUrl: e,
                          docUrl: r,
                          selectedFileTypes: n,
                        });
                        console.log("Response received:", t.data),
                          o(t.data.response);
                      } catch (a) {
                        console.error("Error during submission:", a);
                      }
                    },
                  ...
                  (0, gt.jsx)("button", {
                    onClick: () => {
                      ...
                      document.querySelector(".outputArea").select(),
                  ...
                  (0, gt.jsx)("button", {
                    onClick: () => {
                      console.log("Toggling theme"), h(!p);
                    },
                    className: "toggleThemeButton",
                    children: p ? "Light Mode" : "Dark Mode",
                  }),
                ],
              }),
              (0, gt.jsx)("div", {
                className: "outputContainer",
                children: (0, gt.jsx)("textarea", {
                  value: l,
                  readOnly: !0,
      ...
      r.render(
        (0, gt.jsx)(t.StrictMode, { children: (0, gt.jsx)(yt, {}) }),
        document.getElementById("root"),
      ),
        vt();
    })();
})();
//# sourceMappingURL=main.579a62fe.js.map
